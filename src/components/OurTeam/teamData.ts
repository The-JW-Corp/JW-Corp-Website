...
export const advisors: TeamMemberData[] = [
  {
    name: "Jean-Charles",
    role: "Head of Staff Cube3 (French web3 Incubator) & Head of International Relations ESCE",
    imageUrl:
      "https://firebasestorage.googleapis.com/v0/b/jw-corp.appspot.com/o/our-team%2FJC.png?alt=media&token=47db77a6-4f8b-4f60-a845-84e54241303d",
    xUrl: "https://x.com/JeanCGalli",
    linkedinUrl: "https://www.linkedin.com/in/jcgalli/",
  },
];
