          ...
          <div className="carousel-description-item">
            {swiperIndex === 0 ? (
              <>
                {langageState ? (
                  <>
                    ...
                    leur offre la maison.   Ils réinventent la notion de
                    fidélité en ancrant la confiance sur la blockchain.
                  </>
                ) : (
                  <>
                    Philippe Gonet is a champagne brand that wants to reward
                    their club members through an NFT collection linked to
                    utilities offered by the house. They are reinventing the
                    notion of loyalty by anchoring trust on blockchain. The
                    project required support with blockchain technology.
                  </>
                )}
              </>
            ) : swiperIndex === 1 ? (
              <>
                {langageState ? (
                  <>
                    ...
                    développé sur la Republike Enfine for Democracy (RED) avec
                    de la self moderation.
                  </>
                ) : (
                  <>
                    Republike is a French startup with thousands of users they
                    have a web3 social network universe developed on the
                    Republike Enfine for Democracy (RED) with self moderation.
                  </>
                )}
              </>
            ) : swiperIndex === 2 ? (
              <>
                {langageState ? (
                  <>
                    ...
                    le branding et la stratégie commerciale. Pour les fêtes de
                    fin d’année, le groupe souhaitait réaliser une loterie de
                    NFT offrant une chance de remporter l'une des 6 expériences
              ...
              <>
                {langageState ? (
                  <>
                    ...
                    athlètes. Ces derniers peuvent créer leurs collections de
                    NFT et y associer des contreparties. Ces contreparties
                    peuvent concerner l’accès à certains posts de l’athlète ou
                    bien permettre l’accès à des évènements en présentiel. Les
                  ...
                  <>
                    ...
                    and athletes. The latter can create their own NFT
                    collections and associate counterparties with them. These
                    may include access to certain posts by the athlete, or
                    access to live events. There is no limit to the number of
                    rewards available, and they depend on the athlete's
                    imagination. The platform is focused on sailing, with a view
                    to expanding to other sports.
                  </>
                )}
              </>
            ) : swiperIndex === 4 ? (
              <>
                {langageState ? (
                  <>
                    Borpa est un projet monté par une DAO ils ont lancés 2
                    séries de levée de fonds amassant + d’1.3M, puis ont fait 2
                  ...
                  <>
                    Borpa is a project set up by a DAO. They launched 2 rounds
                    of fund-raising, raising more than 1.3M, and then made 2
                    ...
                    expected. The team consisted of around 20 people, including
                    4 developers.
                  </>
                )}
              </>
              ...
              <>
                {langageState ? (
                  <>
                    ...
                    immobilier en le rendant plus liquide en permettant de
                    pouvoir investir avec un wallet à partir de seulement 100€
                  </>
                ) : (
                  <>
                    Stone Real Estate is a real estate tokenization platform.
                    The team behind the project is a real estate agency. The aim
                    is to democratize real estate investment by making it more
                    liquid, allowing you to invest with a wallet from as little
                    as €100.
                  </>
                )}
              </>
              ...
              <>
                {langageState ? (
                  <>
                    Une DAO composé d’influenceurs européens nous a sollicité
                    afin de développer un outil no code pour lancer des smart
                    contracts au standard ERC404 personnalisables
                  </>
                ) : (
                  <>
                    A DAO made up of European influencers asked us to develop a
                    no-code tool for launching customizable ERC404 standard
                    smart contracts.
                  </>
                )}
              </>
